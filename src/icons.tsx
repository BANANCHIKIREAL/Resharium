...
export const iconData = {
  ...
  info: Info, keyboard: Keyboard, language: Globe, link: Link, local_library: LibraryBig, lock: LockKeyhole,
  ...
  restart_alt: RotateCcw, save: Save, search: Search, search_off: SearchX, history: Clock3,
